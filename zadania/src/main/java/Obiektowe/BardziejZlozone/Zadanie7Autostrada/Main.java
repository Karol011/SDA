package Obiektowe.BardziejZlozone.Zadanie7Autostrada;
/*Zadanie 7:
Stwórz aplikację Autodstrada. Celem zadania będzie implementacja systemu autostrady. Do tej implementacji będzie nam potrzebny klasa Highway która reprezentuje
autostradę, oraz klasa VehicleInfo która reprezentuje zbiór informacji o pojeździe - tam będziemy przechowywać takie dane jak jego rejestracja,
...
3. Stwórz klasę Highway która będzie posiadać :
    ...
    - metodę vehicleEntry(String numer_rejestracyjny, oraz CarType type) - która dodaje do kolekcji nową instancję VehicleInfo oraz wypisuje do konsoli komunikat.
...
Przyjmij pewną stałą kwotę do zapłaty za czas spędzony na autostradzie. Jest to zabawna autostrada, bo zachęca do szybkiej jazdy.
Im szybciej wyjedziemy tym mniej zapłacimy.
...
*- NA AUTOSTRADZIE NIE POWINIEN SIĘ ZNAJDOWAĆ DRUGI SAMOCHÓD O TEJ SAMEJ REJESTRACJI. Jeśli samochód o pewnej rejestracji wjechał już na autostradę rzuć Exception.
 Stwórz własny exception, nazwij go "VehicleAlreadyOnHighwayException". Niech jest to wyjątek niejawny. (edited)
